...
int main() {
	...
	int ensure_less_half, iteration_target, thread_count, contestant_count, game_stages, life_decay_timer, life_cap, decay_floor, shrinking_ceiling;
	...
	read_game_rules("data/game.txt",
		&elim_rate, &ensure_less_half, &life_gain_rate, &life_cap, &decay_floor,
		&life_decay_timer, &shrinking_ceiling, &ld_elim_rate, &ld_life_gain_rate,
	...
	SimulationInfo* sim_info = create_sim_info(iteration_target, base_field, contestant_count, threshold_points,
		game_stages, aggregate_results, elim_rate, ensure_less_half, life_gain_rate, life_cap, decay_floor,
		life_decay_timer, shrinking_ceiling, ld_elim_rate, ld_life_gain_rate, score_renorm);
